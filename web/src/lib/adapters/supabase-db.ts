...
import { databases, DATABASE_ID, COLLECTIONS, Query, userQuery } from '../supabase';
...
import { ID, Permission, Role } from '../supabase';
...
// Helper para converter Timestamp do Supabase para formato compatível
